...
import com.sportmatch.commonlibrary.model.enums.DateStyle;
...
public final class CommonFunction {
   ...
   * @return Time format
   */
  public static String formatDateToString(LocalDateTime dateTime, DateStyle dateStyle) {
   ...
   */
  public static LocalDateTime yyyyMMddFormat(String inputDate) throws ParseException {
   ...
   * @throws ParseException {@link ParseException} Error during parser
   */
  public static LocalDateTime yyyyMMddHHmmSSFormat(String inputDate) throws ParseException {
  ...
  public static LocalDateTime getMinTime(int year, int month, int day) throws ParseException {
    if (day == 0) {
  ...
  public static LocalDateTime getMaxTime(int year, int month, int day) throws ParseException {
    if (day == 0) {
      String time =
          year
              + "-"
  ...
  public static LocalDateTime convertMillisecondToTimeStamp(String date) {
    return new Timestamp(Long.parseLong(date)).toLocalDateTime();
  }

  public static boolean isLessThanTwoDays(LocalDateTime date) {
    Instant currentTime = Instant.now();
    Instant startAt = date.atZone(java.time.ZoneId.systemDefault()).toInstant();
